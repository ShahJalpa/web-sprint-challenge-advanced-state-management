...
import { addSmurf, setFormErrors } from '../actions/index'
...
const AddForm = (props) => {
    ...
    const handleSubmit = e => {
        ...
        if (state.name === "" || state.position === "" || state.nickname === "") {
            props.setFormErrors("Name, position and nickname fields are required.")
...
export default connect (mapStateToProps, {addSmurf, setFormErrors})(AddForm);
